...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference("Metric.count") do
      post metrics_url, params: { metric: { day: @metric.day, location_id: @metric.location_id, max: @metric.max, min: @metric.min, temp: @metric.temp, zipcode: @metric.zipcode } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { day: @metric.day, location_id: @metric.location_id, max: @metric.max, min: @metric.min, temp: @metric.temp, zipcode: @metric.zipcode } }
